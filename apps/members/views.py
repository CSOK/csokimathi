...
def view_profile(request):
    if request.method == 'POST':
        ...
        if profile_pic.is_valid():
            ...
            return redirect(reverse('index:view_profile'))
...
def edit_profile(request):
    ...
    if request.user.is_authenticated and request.user.pk == user.pk:
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                if profile_form.is_valid():
                    ...
                    return redirect(reverse('index:edit_profile'))
        ...
        return render(request, 'members/change_profile.html', args)
...
def change_password(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect(reverse('index:change_password'))
        else:
...
class AccountListView(generic.ListView):
    template_name = 'members/account_list.html'
...
class AccountDetail(generic.DetailView):
    model = Account
    page_template = "members/account_detail.html"
...
class PostDetailView(DateDetailView):
    ...
    month_format = '%m'
    page_template = "members/post_detail.html"
